...
import '../styles/NafathDelegationReview.css';
import '../styles/NafathPageV2.css';

type PageState = 'loading' | 'review' | 'payment-result' | 'rejected' | 'error';
type PaymentResultType = 'processing' | 'success' | 'error';
...
interface NafathDelegationReviewProps {
  onBack?: () => void;
}

const NafathDelegationReview: React.FC<NafathDelegationReviewProps> = ({ onBack }) => {
  ...
  const [paymentResultType, setPaymentResultType] = useState<PaymentResultType>('processing');
  ...
  const delegationInfoRows: DelegationInfo[] = [
    { label: 'اسم المفوض', value: 'محمد أحمد السلمان' },
    { label: 'الصلاحيات', value: 'تجديد اقامة' },
    { label: 'تاريخ البداية', value: '2024-01-15' },
    { label: 'تاريخ النهاية', value: '2025-01-14' },
  ];

  const reviewSubtitle = 'يرجى مراجعة بيانات التفويض أدناه قبل إتمام العملية';
  ...
  const handlePay = async () => {
    ...
    setPaymentResultType('processing');
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      setPageState('error');
      setErrorMessage('حدث خطأ أثناء رفض التفويض.');
    } finally {
      ...
      <main className="nafath-main-v2">
        <div className="nafath-container">
          <div className="content-wrapper">
            {!(pageState === 'payment-result' && paymentResultType === 'success') && (
              <>
                <h1 className="page-title">مراجعة التفويض</h1>
            ...
            {pageState === 'review' && (
              <div className="review-card">
                <div className="card-body">
                  <p className="card-subtitle">{reviewSubtitle}</p>

                  <div className="delegation-info-section">
                    <div className="delegation-info-header">تفاصيل الطلب</div>

                    <div className="delegation-info-card">
                      {delegationInfoRows.map((item, index) => (
                  ...
                  <div className="action-buttons">
                    <button
                      ...
                      onClick={handlePay}
                      disabled={!termsAccepted || isPaying || isRejecting}
                    >
                      {isPaying ? 'جاري الموافقة...' : 'الموافقة والدفع'}
                    </button>
                    <button
            ...
            {pageState === 'payment-result' && (
              <div className="review-card">
                {paymentResultType === 'processing' && (
                  <div className="card-body text-center">
                    <div className="spinner"></div>
                    <p className="loading-text">جاري معالجة الدفع...</p>
                  </div>
                )}
                ...
                {paymentResultType === 'error' && (
                  <div className="card-body text-center">
                    ...
                    <h2 className="state-title error-text">فشل الدفع</h2>
                    <p className="state-description">{paymentMessage}</p>
                  </div>
                )}
              </div>
            )}
            ...
            {pageState === 'rejected' && (
              <div className="review-card success-state">
                <div className="card-body text-center">
                  ...
                  <h2 className="state-title">تم الرفض بنجاح</h2>
                  <p className="state-description">تم رفض طلب التفويض بنجاح</p>
                </div>
              </div>
            )}
            ...
            {/* Error State */}
            {pageState === 'error' && (
              <div className="review-card error-state">
                <div className="card-body text-center">
                  <div className="status-icon error-icon">
                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#ef4444" strokeWidth="2">
                      <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" />
                  ...
                  <h2 className="state-title error-text">خطأ</h2>
              ...
              <div className="terms-modal-backdrop" onClick={() => setShowTermsModal(false)}>
                <div className="terms-modal" onClick={(e) => e.stopPropagation()}>
                  <div className="terms-modal-header">
                    ...
                    <span className="terms-modal-title">الشروط والأحكام</span>
                  </div>
                  <div className="terms-modal-body">
                    <div className="terms-content-box">
                      <div className="terms-section">
                        <h4 className="terms-section-title">مقدمة</h4>
                        <div className="terms-section-content">
                          <p>
                            تلتزم شركة ثقة لخدمات الأعمال («ثقة») بحماية خصوصية وبيانات مستخدمي خدمة مُتم للتفويض الإلكتروني،
                            وذلك وفق نظام حماية البيانات الشخصية في المملكة العربية السعودية ولوائحه التنفيذية.
                          </p>
                          <p className="terms-highlight">
                            باستخدامك لخدمة مُتم فإنك تقر بالاطلاع على سياسة الخصوصية هذه وفهمها.
                          </p>
                        </div>
                      </div>

                      <div className="terms-section">
                        <h4 className="terms-section-title">نطاق التطبيق</h4>
                        <div className="terms-section-content">
                          <p>تسري هذه السياسة على:</p>
                          <ul>
                            <li>جميع مستخدمي خدمة مُتم</li>
                            <li>جميع البيانات الشخصية التي تتم معالجتها عبر أنظمة الخدمة</li>
                            <li>جميع القنوات الرقمية المعتمدة</li>
                          </ul>
                        </div>
                      </div>

                      <div className="terms-section">
                        <h4 className="terms-section-title">البيانات الشخصية التي يتم جمعها</h4>
                        <div className="terms-section-content">
                          <p>قد تشمل البيانات الشخصية ما يلي:</p>

                          <h5 className="terms-subsection-title">بيانات التعريف</h5>
                          <ul>
                            <li>الاسم الكامل</li>
                            <li>رقم الهوية الوطنية / الإقامة / السجل التجاري</li>
                            <li>تاريخ الميلاد (عند الاقتضاء)</li>
                          </ul>

                          <h5 className="terms-subsection-title">بيانات التواصل</h5>
                          <ul>
                            <li>رقم الجوال</li>
                            <li>البريد الإلكتروني</li>
                          </ul>

                          <h5 className="terms-subsection-title">بيانات التفويض</h5>
                          <ul>
                            <li>بيانات المفوض والمفوض إليه</li>
                            <li>نطاق ومدة وحالة التفويض</li>
                            <li>سجلات الإصدار والتعديل والإلغاء</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="terms-modal-footer">
                    <button className="btn-reject" onClick={() => setShowTermsModal(false)}>
                      إغلاق
                    </button>
                  </div>
                </div>
...
export default NafathDelegationReview;
